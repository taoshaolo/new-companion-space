<template>
  ...
  <div v-else>
    ...
    <van-grid :border="false" style="justify-content: space-around;">
      ...
      <van-grid-item icon="records-o" icon-color="#a778fc" text="我的博文" to="/user/blog" />
    </van-grid>
    <div class="center">
...
onMounted(async () => {
  let res = await request.get("/message/like/num");
  if (res) {
    likeNum.value = Number(res);
  }
});
